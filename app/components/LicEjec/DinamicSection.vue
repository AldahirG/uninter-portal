            ...
            <div class="info-card__content">
              ...
              <ul v-if="slide.links" class="info-card__links">
                <li v-for="(link, idx) in slide.links" :key="idx">
                  <a :href="link.href" class="info-link">
                    <span class="info-link__bullet">•</span>
                    {{ link.label }}
                  </a>
                </li>
              </ul>
              ...
              <div v-if="slide.btn" class="info-card__action">
                <a :href="slide.btn.link" class="info-btn">
                  {{ slide.btn.label }} <ArrowRight :size="16" />
                </a>
              </div>
            </div>
          </div>
...
:deep(.info-swiper .swiper-wrapper) {
  align-items: stretch;
}

:deep(.info-swiper .swiper-slide) {
  height: auto;
}
...
:deep(.info-swiper .swiper-pagination) {
  bottom: 0;
}

:deep(.info-swiper .swiper-pagination-bullet) {
...
:deep(.info-swiper .swiper-pagination-bullet-active) {
  background-color: #0073b4;
  border-radius: 8px;
  width: 24px;
}
