...
import { Sparkles, BookOpen, Globe2, Layers, Calendar, ShieldCheck, ChevronRight, GraduationCap } from "lucide-vue-next";
  ...
  <div class="biu-hero-wrapper">
    <section class="biu-hero">
      <div class="biu-hero__bg">
        <img src="/images/bachillerato/hero/2.jpg" alt="Estudiantes BIU UNINTER" class="biu-hero__img">
        <div class="biu-hero__overlay"></div>
        <div class="biu-hero__overlay2"></div>
      </div>
      <div class="biu-hero__deco biu-hero__deco--tl" aria-hidden="true"><Sparkles :size="32" /></div>
      <div class="biu-hero__deco biu-hero__deco--tr" aria-hidden="true"><BookOpen :size="28" /></div>
      <div class="biu-hero__deco biu-hero__deco--br" aria-hidden="true"><Globe2 :size="26" /></div>
      
      <div class="biu-container biu-hero__content">
        <div class="biu-hero__inner">
          <div class="biu-hero__eyebrow">
            <img src="/images/logo-uninter.png" alt="Bachillerato Internacional UNINTER" class="biu-hero__logo-full" onerror="this.style.display = 'none'">
          </div>
          <p class="biu-hero__tagline">CONOCE LO QUE BIU TIENE PARA TI</p>
          <h1 class="biu-hero__title">
            <span class="biu-hero__title-main">BACHILLERATO</span>
            <span class="biu-hero__title-sub">Bilingüe & Multicultural</span>
          </h1>
          <p class="biu-hero__desc">
            Prepárate para el futuro con una formación académica de excelencia en un ambiente internacional. Domina el inglés, desarrolla habilidades tecnológicas y conecta con el mundo desde Cuernavaca.
          </p>
          <div class="biu-hero__ctas-new">
            <a href="#vida-academica" class="biu-btn-card">
              <div class="btn-icon"><ChevronRight :size="28" /></div>
              <span>Conoce BIU</span>
            </a>
            <a href="#oferta-biu" class="biu-btn-card">
              <div class="btn-icon"><GraduationCap :size="28" /></div>
      ...
      <div class="biu-container biu-hero__stats-inner">
        <div v-for="stat in stats" :key="stat.label" class="biu-stat">
          <div class="biu-stat__icon">
            <component :is="stat.icon === 'Layers' ? Layers : stat.icon === 'Calendar' ? Calendar : stat.icon === 'BookOpen' ? BookOpen : stat.icon === 'Globe' ? Globe2 : ShieldCheck" :size="28" />
          </div>
...
@media(max-width:768px){
  .biu-hero{flex-direction:column;height:auto;min-height:clamp(500px,85vh,800px);padding-top:5rem}
...
@media(max-width:480px){
  .biu-hero__ctas-new{flex-direction:row;gap:1rem}
