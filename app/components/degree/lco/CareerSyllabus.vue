...
const categories = [
  ...
  { label: "🎥 Producción Audiovisual", value: "audiovisual" },
  { label: "✍️ Periodismo y Medios", value: "periodismo" },
  { label: "📈 Marketing y R.P.", value: "marketing" },
  { label: "🌐 Formación General", value: "general" },
];

// Mapeo de materias a sus respectivas categorías
const subjectCategories: Record<string, string> = {
  // Producción Audiovisual
  "Fundamentos Técnicos de los Medios de Comunicación": "audiovisual",
  "Fotografía Digital": "audiovisual",
  "Producción de Radio": "audiovisual",
  "Producción de Televisión": "audiovisual",
  "Guionismo Audiovisual": "audiovisual",
  "Edición Digital": "audiovisual",
  "Cine y Narrativa Visual": "audiovisual",
  "Dirección de Arte": "audiovisual",
  "Producción Transmedia": "audiovisual",
  "Portafolio Profesional": "audiovisual",

  // Periodismo y Medios
  "Teorías de la Comunicación I": "periodismo",
  "Taller de Ortografía, Lectura y Redacción": "periodismo",
  "Teorías de la Comunicación II": "periodismo",
  "Taller de Expresión Oral y Escrita": "periodismo",
  "Géneros Periodísticos": "periodismo",
  "Periodismo Digital": "periodismo",
  "Análisis de la Cultura Contemporánea": "periodismo",
  "Seminario de Titulación I": "periodismo",
  "Seminario de Titulación II": "periodismo",

  // Marketing y Corporativa
  "Mercadotecnia Básica": "marketing",
  "Relaciones Públicas": "marketing",
  "Comunicación Organizacional": "marketing",
  "Publicidad Estratégica": "marketing",
  "Marketing Digital": "marketing",
  "Gestión de Redes Sociales": "marketing",
  "Desarrollo de Emprendedores": "marketing",

  // Formación General
  "Análisis Estadístico": "general",
  "Lengua Extranjera I": "general",
  "Historia Mundial Contemporánea": "general",
  Computación: "general",
  "Lengua Extranjera II": "general",
  "Diseño Gráfico Básico": "general",
  "Lengua Extranjera III": "general",
  "Comunicación Política": "general",
  "Lengua Extranjera IV": "general",
  "Investigación Cuantitativa": "general",
  "Legislación de los Medios": "general",
  "Optativa I": "general",
  "Investigación Cualitativa": "general",
  "Optativa II": "general",
  "Ética Profesional": "general",
  "Prácticas Profesionales I": "general",
  "Prácticas Profesionales II": "general",
};
...
const syllabusData = [
  {
    id: "sem-1-2",
    tabLabel: "Semestres 1 y 2",
    blocks: [
      {
        title: "Primer Semestre",
        subjects: [
          "Teorías de la Comunicación I",
          "Fundamentos Técnicos de los Medios de Comunicación",
  ...
  {
    id: "sem-5-6",
    tabLabel: "Semestres 5 y 6",
    blocks: [
      {
        title: "Quinto Semestre",
        subjects: [
          "Cine y Narrativa Visual",
...
const activeTabBlocks = computed(() => {
  return syllabusData[activeTabIndex.value]?.blocks || [];
});

// Helper function to check category class
const getSubjectCategoryClass = (subject: string) => {
  return subjectCategories[subject] || "general";
};

// Helper function to check if highlighted
const isSubjectHighlighted = (subject: string) => {
  if (selectedCategory.value === "all") return false;
  return subjectCategories[subject] === selectedCategory.value;
};

// Helper function to check if dimmed
const isSubjectDimmed = (subject: string) => {
  if (selectedCategory.value === "all") return false;
  return subjectCategories[subject] !== selectedCategory.value;
};
</script>
...
<template>
  <section class="career-syllabus-section">
