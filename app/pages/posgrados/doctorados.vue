  ...
  <div class="pg-level-page">
        ...
        <div class="pg-hero__bg">
          <picture class="pg-hero__picture biu-hero__picture dp-hero__picture">
            <source
              ...
              srcset="/images/posgrados/heroMobile/21.png"
            />
            <img
              src="/images/posgrados/hero/banerDoctorados.png"
              alt="Doctorados UNINTER"
    ...
    <section id="listado" class="pg-list-sec oe-section">
      <div class="pg-wrap uninter-container">
        ...
        <div class="oe-grid">
          <div v-for="(area, index) in data" :key="index" class="oe-card">
