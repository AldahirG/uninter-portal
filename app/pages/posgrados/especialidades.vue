  ...
  meta: [
    {
      name: "description",
      content:
        "Especialidades de Posgrado UNINTER - programas de profundización profesional en administración de obra, marketing digital, criminología, docencia y más.",
    },
  ],
});
        ...
        <div class="pg-container pg-hero__content">
          <div class="pg-hero__inner">
            ...
            <h1 class="pg-hero__title">
              <span class="pg-hero__title-main">ESPECIALIDADES</span>
              <span class="pg-hero__title-sub">Profundización Profesional</span>
            </h1>
            ...
            <div class="pg-hero__ctas-new">
              <a href="#listado" class="pg-btn-card">
                <div class="btn-icon">
      ...
      <div class="pg-wrap uninter-container">
        <div class="pg-sec-header oe-header">
          <div>
            ...
            <h2 class="pg-title uninter-section-title">Explora nuestras <em>Especialidades</em></h2>
        ...
        <!-- Componente Interactivo Listado -->
        <div class="oe-grid">
          <div v-for="(area, index) in especialidades" :key="index" class="oe-card">
...
.oe-card {
  background: #fff;
  border: 1px solid rgba(141, 143, 56, 0.4);
  border-radius: 16px;
  box-shadow: 0 4px 15px #8d8f381a;
  display: flex;
...
.oe-card:hover {
  border-color: #8d8f38cc;
  box-shadow: 0 15px 30px -5px #8d8f3840;
...
.oe-drawer-badge {
  ...
  align-items: center;
  gap: 0.5rem;
  background: rgba(141, 143, 56, 0.1);
  color: #8d8f38;
  padding: 0.5rem 1rem;
  border-radius: 99px;
  font-size: 0.8rem;
...
.oe-btn--solid {
  ...
  color: #fff;
  border: none;
  box-shadow: 0 4px 15px rgba(141, 143, 56, 0.3);
}

.oe-btn--solid:hover {
  background: #717723;
  transform: translateY(-2px);
  box-shadow: 0 8px 25px rgba(141, 143, 56, 0.4);
}

.oe-btn--outline {
  background: transparent;
  color: #8d8f38;
  border: 2px solid #8d8f38;
}

.oe-btn--outline:hover {
  background: rgba(141, 143, 56, 0.05);
}
...
.pg-hero__title-main {
  ...
  font-weight: 900;
  letter-spacing: -0.02em;
  text-shadow: 0 4px 24px hsla(55, 84%, 73%, 0.25);
}
.pg-hero__title-main,
.pg-hero__title-sub {
  font-family: var(--font-serif, Georgia, serif);
...
.pg-hero__stats-bar {
  ...
  background-color: #1a1c09d9;
  background-image: radial-gradient(
    circle at 50% 50%,
    hsla(55, 84%, 73%, 0.15) 0,
    transparent 60%
  );
  background-position: 50%;
  border-bottom: 1px solid rgba(0, 0, 0, 0.6);
  border-top: 1px solid hsla(55, 84%, 73%, 0.2);
  box-shadow:
    0 -4px 24px #0000004d,
    0 12px 32px #0009;
  padding: 1.5rem 0;
...
.pg-stat {
  border-right: 1px solid hsla(55, 84%, 73%, 0.3);
  flex: 1;
  flex-direction: row;
  gap: 1rem;
  justify-content: center;
