  ...
  <div class="siu-page">
    ...
    <section class="siu-hero">
      <div class="siu-hero__bg">
        <img src="/images/Secundaria/hero/17.jpg" alt="SIU Multicultural UNINTER" class="siu-hero__img">
      ...
      <div class="siu-wrap siu-hero__content">
        <div class="siu-hero__inner">
          ...
          <p class="siu-hero__desc">
            Formación de jóvenes inclusivos mediante intercambios internacionales, aprendizaje de múltiples idiomas y desarrollo sostenible.
          </p>
    ...
    <div class="siu-hero__stats-bar">
      <div class="siu-wrap siu-hero__stats-inner">
        ...
        <div class="siu-stat">
          <div class="siu-stat__icon"><Icon name="mdi:earth" size="28" /></div>
          <div class="siu-stat__text">
