  ...
  <div class="siu-hero-wrapper">
    ...
    <div class="siu-hero__stats-bar">
      <div class="siu-wrap siu-hero__stats-inner">
        ...
        <div class="siu-stat">
          <div class="siu-stat__icon"><Icon name="mdi:calendar-month-outline" size="28" /></div>
          <div class="siu-stat__text">
        ...
        <div class="siu-stat">
          <div class="siu-stat__icon"><Icon name="mdi:basketball" size="28" /></div>
          <div class="siu-stat__text">
...
.siu-hero-wrapper{--s:#ecab00;--sd:#c49000;--sl:#f5c842;--sbg:#1a1500;--sa:#fceeb5;--s-blue:#00b6ec;--s-blue-dark:#0091d7;background-color:var(--sbg)}
...
/* Decorativos */
.siu-hero__deco { position: absolute; z-index: 2; opacity: 0.14; color: #ecab00; }
.siu-hero__deco--tl { top: 14%; left: 5%; }
.siu-hero__deco--tr { top: 10%; right: 8%; }
.siu-hero__deco--br { bottom: 20%; right: 12%; }

/* Sticker HOLA/HELLO */
.siu-hero__sticker { position: absolute; z-index: 3; display: flex; flex-direction: column; align-items: center; gap: 0.1rem; transform: rotate(-8deg); opacity: 0.88; }
.siu-hero__sticker--hola { top: 16%; right: 28%; }
.sticker-line { background: #fff; color: #1a1500; font-size: clamp(0.9rem, 2vw, 1.2rem); font-weight: 900; letter-spacing: 0.08em; padding: 0.25rem 0.9rem; border-radius: 6px; box-shadow: 2px 3px 8px rgba(0, 0, 0, 0.35); line-height: 1; }
.sticker-line--en { background: #00a8e8; color: #fff; }
.sticker-arrow { font-size: 1.2rem; color: #fff; font-weight: 900; line-height: 1; }
...
console.log('HeroBanner rewritten completely to match siu-bilingue style distribution');
